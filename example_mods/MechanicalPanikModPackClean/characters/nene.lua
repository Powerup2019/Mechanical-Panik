...
for i = 1,7 do
setProperty('viz'..i..'.visible', false)
end
end
...
playAnim('abot',"")
setProperty('abot.anim.curFrame', 1);
end
end
...
table.insert(sampl, byte / 65535 * 5)
end
end

for i = 1, 7 do
animFrame = math.floor(sampl[i] * 6)

if animFrame < 0 then
return;
end

setProperty('viz'..i..'.visible', animFrame > 0)
