...
local iconComposer = 'credits/Reddash'
local iconCoder = 'credits/pwr'
local iconArtist = 'credits/missing'
local iconCharter = 'credits/Reddash'

-- Credit contents
local songName = 'Autotuned'
local composer = 'Composer: RedDash'
local coder = 'Coder: PWR'
local artist  = 'Artist: Multiple People'
local charter = 'Charter: RedDash'
