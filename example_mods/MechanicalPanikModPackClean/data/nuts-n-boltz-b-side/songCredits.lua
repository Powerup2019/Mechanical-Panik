...
local iconComposer = 'credits/missing'
local iconCoder = 'credits/pwr'
local iconArtist = 'credits/pwr'
local iconCharter = 'credits/gamerman'

-- Credit contents
local songName = 'NNB B-Side'
local composer = 'Composer: Chibi'
local coder = 'Coder: PWR'
local artist  = 'Artist: PWR and Gamerman'
local charter = 'Charter: Gamerman and PWR'
